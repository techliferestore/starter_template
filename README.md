<p align="center"><h1>TechLifeRestore</h1></p>
...
A number of custom commands are available to add and update role-permissions. , where you will find the list of commands with examples. 
...
Follow the steps mentioned below to install and run the project. Y
